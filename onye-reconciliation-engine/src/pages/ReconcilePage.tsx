import { RECONCILE_SCENARIOS as MOCK_SCENARIOS } from "../data/data";
    ...
    <div className="flex flex-col gap-5">
      <div className="bg-white rounded-xl shadow p-6 flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <p className="text-sm font-semibold text-gray-500 w-full">
            Paste your reconciliation request or load one of the example
            scenarios.
          </p>
        ...
        <button
          ...
          className="self-end px-6 py-2 cursor-pointer bg-green-600 hover:bg-green-800 disabled:bg-green-300 text-white font-semibold rounded-lg transition-colors"
        >
          {loading ? "Analyzing..." : "Reconcile"}
        </button>
      </div>
